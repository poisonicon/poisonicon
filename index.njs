...
import BullseyeStroke from './bullseye/stroke';
import BullseyeFill from './bullseye/fill';
...
import OpenBookStroke from './open-book/stroke';
import OpenBookFill from './open-book/fill';
...
import PersonCogStroke from './person-cog/stroke';
import PersonCogFill from './person-cog/fill';
...
import QrcodeStroke from './qrcode/stroke';
import QrcodeFill from './qrcode/fill';
import QuestionMarkStroke from './question-mark/stroke';
import QuestionMarkFill from './question-mark/fill';
import RefreshStroke from './refresh/stroke';
import RefreshFill from './refresh/fill';
...
import StarStroke from './star/stroke';
import StarFill from './star/fill';
import StockStroke from './stock/stroke';
...
function pickIcon(name, type) {
  ...
  if(name === 'bullseye' && type === 'stroke') return BullseyeStroke;
  if(name === 'bullseye' && type === 'fill') return BullseyeFill;
  ...
  if(name === 'open-book' && type === 'stroke') return OpenBookStroke;
  if(name === 'open-book' && type === 'fill') return OpenBookFill;
  ...
  if(name === 'person-cog' && type === 'stroke') return PersonCogStroke;
  if(name === 'person-cog' && type === 'fill') return PersonCogFill;
  ...
  if(name === 'qrcode' && type === 'stroke') return QrcodeStroke;
  if(name === 'qrcode' && type === 'fill') return QrcodeFill;
  if(name === 'question-mark' && type === 'stroke') return QuestionMarkStroke;
  if(name === 'question-mark' && type === 'fill') return QuestionMarkFill;
  if(name === 'refresh' && type === 'stroke') return RefreshStroke;
  if(name === 'refresh' && type === 'fill') return RefreshFill;
  ...
  if(name === 'star' && type === 'stroke') return StarStroke;
  if(name === 'star' && type === 'fill') return StarFill;
  if(name === 'stock' && type === 'stroke') return StockStroke;
